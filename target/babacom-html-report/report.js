...
formatter.scenario({
  ...
  "description": "",
  "id": "as-a-customer-i-want-to-check-end-to-end-functionality;user-wants-to-register-his-valid-detail",
  "type": "scenario",
  "keyword": "Scenario",
  "tags": [
    {
...
formatter.step({
  "line": 6,
  "name": "user entered his valid details",
  "keyword": "When "
});
formatter.step({
  "line": 7,
  "name": "user will get msg register successful",
  "keyword": "Then "
});
formatter.match({
...
formatter.match({
  "location": "MyStepdefs.userEnteredHisValidDetails()"
});
formatter.result({
  "status": "skipped"
});
formatter.match({
  "location": "MyStepdefs.userWillGetMsgRegisterSuccessful()"
});
formatter.result({
  "status": "skipped"
});
